...
const int SENSOR_PIN[SENSOR_NUM] = {A4, A3, A2, A1, A0}; // A0 Clear, A1 Clear, A2 Clear, A3 Clear, A4 Clear
...
int line_detection() {
  int lineDetect_left = digitalReadFast(line_left);
  int lineDetect_right = digitalReadFast(line_right);
