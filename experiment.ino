...
void loop() {
  ...
  int minFront = min({distance_frontMiddle, distance_frontLeft, distance_frontRight});

  

  if (distance_frontMiddle < 75 && distance_frontMiddle < distance_frontLeft && distance_frontMiddle < distance_frontRight) { // opponent is directly in front
    Serial.println("hi middle");
    leftMotor.setSpeed(255);
    rightMotor.setSpeed(255);
  } else if (distance_frontLeft < 75 && distance_frontLeft < distance_frontMiddle && distance_frontLeft < distance_frontRight) { // opponent is at frontLeft
    ...
    */
  } else if (distance_frontRight < 75 && distance_frontRight < distance_frontMiddle && distance_frontRight < distance_frontLeft) { // opponent is at frontRight
